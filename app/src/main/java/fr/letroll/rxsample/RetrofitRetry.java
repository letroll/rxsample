...
/**
 * Created by jquievreux on 06/08/2014.
 */
public class RetrofitRetry extends Activity{
    ...
    private Observer<? super String> retrofitObserver= new Observer<String>() {
        ...
        public void onError(Throwable throwable) {
            Toast.makeText(RetrofitRetry.this, "Error:" + throwable.getMessage(), Toast.LENGTH_SHORT).show();
        }
    ...
    private Observable getFollowersObservable() {
        return Observable.from(GITHUB_MEMBERS).retry(3)
